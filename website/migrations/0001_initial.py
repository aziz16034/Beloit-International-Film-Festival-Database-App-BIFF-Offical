    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Judging', models.CharField(default='-', max_length=100000)),
                ('Title_in_Original_Language', models.CharField(default='-', max_length=100000)),
                ('Year_Submitted', models.CharField(default='-', max_length=100000)),
                ('Duration', models.CharField(default='-', max_length=100000)),
                ...
                ('Submission_City', models.CharField(default='', max_length=100000)),
